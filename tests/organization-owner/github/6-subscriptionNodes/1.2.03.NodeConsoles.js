...
var testSuiteNum = '1.';
var testSuiteDesc = 'Node Consoles';
...
describe(testSuite,
  function () {
    ...
    describe('ClusterNode Consoles Controller',
      function () {
        ...
        it('get ClusterNode Console By ClusterNodeId',
          function (done) {
            this.timeout(0);

            if (!clusterNodeId) return done();

            shippable.getClusterNodeConsoleByClusterNodeId(clusterNodeId,
              function(err) {
                if (err) {
                  isTestFailed = true;
                  var testCase =
                    util.format(
                      '\n- [ ] %s: getClusterNodeConsoleByClusterNodeId failed' +
